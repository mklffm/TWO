...
const translations = {
  ...
  ar: {
    ...
    ourStory: "قصتنا",
    storyContent: "تأسست ميرا بوكينج في عام 2020، وسرعان ما أصبحت شركة رائدة في مجال معالجة التأشيرات وخدمات السفر. بدأت رحلتنا بمهمة بسيطة: جعل السفر الدولي متاحًا وخاليًا من المتاعب للجميع.",
    ourMission: "مهمتنا",
      ...
      <main className="container mx-auto px-4 py-12 pt-28">
        ...
        <section className="mb-16">
          <div className="bg-gray-50 rounded-xl shadow-lg overflow-hidden">
            <div className="p-8 lg:p-12">
              <h2 className="text-3xl font-bold mb-6 text-center text-gray-800">{t.ourTeam}</h2>
              <p className="text-gray-600 text-center max-w-3xl mx-auto mb-10">{t.teamContent}</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="bg-white p-4 rounded-xl shadow-md text-center">
                  ...
                  <h3 className="font-bold text-gray-800">Ahmed M.</h3>
                ...
                <div className="bg-white p-4 rounded-xl shadow-md text-center">
                  ...
                  <p className="text-sm text-gray-600">Visa Specialist</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl shadow-md text-center">
                  ...
                  <h3 className="font-bold text-gray-800">Karim B.</h3>
                ...
                <div className="bg-white p-4 rounded-xl shadow-md text-center">
                  ...
                  <h3 className="font-bold text-gray-800">Amina R.</h3>
