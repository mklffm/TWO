        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex items-center">
              <a href="https://www.instagram.com/mira_booking_visa/" className="bg-gradient-to-r from-primary-600 to-secondary-500 text-white p-3 rounded-full transition-all hover:shadow-lg flex items-center gap-2">
                ...
                <span className={`${isRTL ? 'mr-1' : 'ml-1'} text-sm font-medium`}>@mira_booking_visa</span>
              </a>
            </div>
          </div>
